const input1 = ["dssmtmrkonedbbhdhjbf9hq",
...
const mainA = function (input) {
	...
	for (const line of input) {
		...
		sum += Number(a.toString() + b.toString());
	}
	console.log("RESULT:", sum);
};

const mainB = function (input) {
	let sum = 0;
	for (const line of input) {
		...
		sum += Number(firstNumber.toString() + lastNumber.toString());
	}
	console.log("RESULT:", sum);
};
